{
	...
	'author': 'APS',
	'license': 'LGPL-3',
	'depends': ['base', 'web', 'mail', 'portal', 'hr', 'hr_skills', 'partner_multi_relation', 'spreadsheet_dashboard', 'calendar', 'aps_ai', 'aui_enhancements'],
	'post_init_hook': 'post_init_hook',
	'data': [
		'security/groups.xml',
		'security/ir.model.access.csv',
		'security/aps_sis_security.xml',
		'security/weekly_submission_result_security.xml',
		'data/cron.xml',
		...
		'views/resources/aps_resources_views.xml',
		'views/resources/aps_resource_hierarchy_views.xml',
		'views/resources/aps_resource_types_views.xml',
		'views/resources/aps_resource_tags_views.xml',
		'views/aps_location_views.xml',
		'views/aps_assign_students_wizard_views.xml',
		'views/resources/aps_resource_task_views.xml',
		'views/resources/aps_resource_submission_views.xml',
		'views/resources/aps_resource_submission_views_for_students.xml',
		'views/resources/aps_resource_notes_popup_views.xml',
		'views/aps_dashboard_views.xml',
		'views/aps_submission_mass_update_wizard_views.xml',
		'views/resources/aps_resource_mass_update_wizard_views.xml',
		...
		'wizard/aps_academic_week_generate_wizard_views.xml',
		...
		'views/awards/aps_vote_analysis_dashboard_views.xml',
		'views/aps_gradebook_grid_views.xml',
		'views/aps_student_matrix_views.xml',
		'views/aps_school_calendar_report_views.xml',
		'wizard/aps_school_calendar_generate_wizard_views.xml',
		'views/core/aps_class_views.xml',
		'views/core/aps_class_tag_views.xml',
		'views/core/aps_teacher_views.xml',
		'data/aps_student_enrolment_status_data.xml',
		...
		'wizard/class/aps_class_rollover_wizard_views.xml',
		'wizard/aps_year_level_rollover_wizard_views.xml',
		'wizard/class/aps_class_tag_enrol_wizard_views.xml',
		'wizard/class/aps_student_class_bulk_wizard_views.xml',
		...
		'views/weekly_submission_results_views.xml',
		'views/weekly_submission_result_views.xml',
		...
		'reports/weekly_submission_result_report.xml',
		...
		'views/asc_timetable/asctt_workload_views.xml',
	...
	'assets': {
		'web.assets_backend': [
			...
			'aps_sis/static/src/js/submission_score_widget.js',
			'aps_sis/static/src/xml/submission_score_widget.xml',
			'aps_sis/static/src/css/submission_score_widget.css',
			...
			'aps_sis/static/src/js/awards/voting.js',
			'aps_sis/static/src/js/float_sentinel_widget.js',
			'aps_sis/static/src/js/filter_preset_service.js',
            'aps_sis/static/src/js/timetable_calendar_view.js',
            ...
            # Slickgrid-Universal library (replaces 6pac/SlickGrid)
            ...
            'aps_sis/static/src/js/resource_tree_widget.js',
            'aps_sis/static/src/xml/resource_tree_widget.xml',
